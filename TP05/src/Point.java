...
public class Point {
	...
	/** Dessiner le Point sur un écran.
	...
	/**
	 * Dessine un Point au format SVG.
	 * @param afficheurSVG classe de formatage SVG
	 */
	public void dessiner(AfficheurSVG afficheurSVG) {
		afficheurSVG.dessinerPoint(this.getX(), this.getY(), this.couleur);
	}

	/**
	 * Affiche le Point au format texte dans le terminal.
	 * @param afficheurTexte classe de formatage textuel
	 */
	public void dessiner(AfficheurTexte afficheurTexte) {
		afficheurTexte.dessinerPoint(this.getX(), this.getY(), this.couleur);
	}
