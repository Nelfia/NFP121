...
public class Segment {
	...
	*/
	...
	/** Dessiner un segment sur un écran.
	 * @param ecran sur lequel on dessine le Point
	 */
	...
	/**
	 * Dessiner un segment au format SVG dans un fichier.
	 * @param afficheurSVG
	 */
	public void dessiner(AfficheurSVG afficheurSVG) {
		afficheurSVG.dessinerLigne(this.extremite1.getX(), this.extremite1.getY(), this.extremite2.getX(), this.extremite2.getY(), this.couleur);
	}

	/**
	 * Dessiner textuellement le segment dans le terminal.
	 * @param afficheurTexte
	 */
	public void dessiner(AfficheurTexte afficheurTexte) {
		afficheurTexte.dessinerLigne(this.extremite1.getX(), this.extremite1.getY(), this.extremite2.getX(), this.extremite2.getY(), this.couleur);
	}
