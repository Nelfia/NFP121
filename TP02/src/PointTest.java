...
public class PointTest {
	...
	public void testInitialisation() {
		...
		assertEquals(4, p2.getX(), 0);
		assertEquals(-2, p2.getY(), 0);
	}
	...
	public void testSetColor(){
		...
		assertEquals(p1.getCouleur(), Color.blue);
		p1.setCouleur(Color.magenta);
		assertEquals(p1.getCouleur(), Color.magenta);
	}
