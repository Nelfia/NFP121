...
public class EditeurLigne {
	...
	public EditeurLigne(Ligne l) {
		...
		// Créer le sous menu
		menuCurseur = new SousMenu("Sous-Menu curseur");
		...
		menuPrincipal.ajouter("Modifier la position du curseur", menuCurseur);
		...
		menuPrincipal.ajouter("Supprimer le caractère sous le curseur",
				new CommandeCaractereSupprimer(ligne));
	}
